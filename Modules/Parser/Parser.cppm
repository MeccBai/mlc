...
export namespace mlc::parser {
    ...
    public:
        ...
        [[nodiscard]] functionWarper functionDeclSpliter(std::string_view _functionHeader,bool _isExported = false) const;
        ...
        void extractExportSymbols(const std::filesystem::path &_importPath);

...
%il17 = getelementptr %struct.d, ptr %il15, i32 0, i32 0
store ptr %c1, ptr %il17
%il18 = getelementptr %struct.d, ptr %il15, i32 0, i32 1
store i32 100, ptr %il18
%ma19 = getelementptr %struct.a, ptr %a1, i32 0, i32 0
%ma20 = getelementptr %struct.b, ptr %ma19, i32 0, i32 0
...
store i32 30, ptr %ma26
%x = alloca i32, align 4
%ma28 = getelementptr %struct.d, ptr %d1, i32 0, i32 0
%ma30 = load ptr, ptr %ma28, align 8
%ma31 = getelementptr %struct.c, ptr %ma30, i32 0, i32 0
%ma32 = getelementptr %struct.a, ptr %ma31, i32 0, i32 0
%ma33 = getelementptr %struct.b, ptr %ma32, i32 0, i32 0
%ma34 = load i32, ptr %ma33, align 4
%tr35 = add i32 %ma34, 30
store i32 %tr35, ptr %x, align 4
%y = alloca i32, align 4
%tr37 = add i32 10, 20
%tr38 = add i32 %tr37, 30
store i32 %tr38, ptr %y, align 4
%str = alloca [10 x i8], align 16
%il40 = getelementptr [10 x i8], ptr %str, i32 0
%il41 = getelementptr [10 x i8], ptr %il40, i32 0, i32 0
store i8 37, ptr %il41
...
%tr53 = add i32 %51, %52
%54 = call i32 (ptr, i32, ...) @printf(ptr %str, i32 %tr53)
%55 = alloca i32
store i32 %54, ptr %55
ret i32 0
}
